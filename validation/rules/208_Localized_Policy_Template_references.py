class Rule:
    ...
    feature_template_level2 = ['bgp_template', 'ethernet_interface_templates', 'igmp_template', 'ipsec_interface_templates', 'svi_interface_templates', 'ospf_template', 'secure_internet_gateway_template', 'sig_credentials_template', 'container_profile', 'cellular_profile_templates', 'gre_interface_templates', 'cellular_interface_templates']
