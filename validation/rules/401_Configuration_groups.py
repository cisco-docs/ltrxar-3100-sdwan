...
class Rule:
    ...
    required_variables_paths = [
        ...
        "sdwan.feature_profiles.service_profiles.bgp.ipv6_neighbors.address_families.maximum_prefixes_threshold_variable",
        "sdwan.feature_profiles.service_profiles.bgp.ipv6_neighbors.remote_as_variable",
        "sdwan.feature_profiles.service_profiles.bgp.ipv4_networks.prefix_address_variable",
        "sdwan.feature_profiles.service_profiles.bgp.ipv6_redistributes.protocol_variable",
        ...
        "sdwan.feature_profiles.service_profiles.lan_vpns.nat_port_forward.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.nat_port_forward.source_ip_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.nat_port_forward.source_port_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.nat_port_forward.translate_ip_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.nat_port_forward.translate_port_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv4_routes.aggregates.aggregate_address_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv4_routes.aggregates.subnet_mask_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv4_routes.networks.network_address_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv4_routes.networks.subnet_mask_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv4_routes.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv6_routes.aggregates.aggregate_prefix_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv6_routes.networks.prefix_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.omp_advertise_ipv6_routes.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_from_global.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_from_global.redistributions.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_from_service.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_from_service.redistributions.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_from_service.source_vpn_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_to_global.protocol_variable",
        "sdwan.feature_profiles.service_profiles.lan_vpns.route_leak_to_global.redistributions.protocol_variable",
        ...
        "sdwan.feature_profiles.service_profiles.lan_vpns.static_nat.direction_variable",
