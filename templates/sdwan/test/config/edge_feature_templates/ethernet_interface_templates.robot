...
Verify Edge Feature Template Ethernet Feature Template {{ ft_yaml.name }}
    ...
    ${adaptive_qos_remote}=   Get Value From Json   ${ft.json()}        $..["qos-adaptive"]..vipType
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $..["dhcp-distance"]
    ...
    ${enable_sgt_remote_vt}=   Get Value From Json   ${ft.json()}        $..trustsec.enable.vipType
    ${enable_sgt_remote_vv}=   Get Value From Json   ${ft.json()}        $..trustsec.enable.vipValue
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $..ipv6.["access-list"].vipValue[?(@.direction.vipValue=="in")]..["acl-name"]
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $..ipv6.["access-list"].vipValue[?(@.direction.vipValue=="out")]..["acl-name"]
    ...
    ${ipv4_address_dhcp_remote}=   Get Value From Json   ${ft.json()}        $..ip..["dhcp-client"].vipValue
    ...
    ${ipv4_nat_remote_const}=   Get Value From Json   ${ft.json()}        $..nat[?(@.vipType == "constant")]
    ${ipv4_nat_remote_var}=   Get Value From Json   ${ft.json()}        $..nat[?(@.vipType == "variableName")]
...
{% for tracking_object_index in range(ft_yaml.ipv4_vrrp_groups[vrrp_group_index].tracking_objects | default([]) | length()) %}
    ...
    ${ipv4_vrrp_track_objects}=    Get Value From Json    ${ft.json()}    $.vrrp.vipValue[{{vrrp_group_index}}].tracking-object
    Log    === IPv4 VRRP Group {{vrrp_group_index}} Tracking Object {{tracking_object_index}} ===
    Should Be Equal Value Json Yaml UX1    ${ipv4_vrrp_track_objects}[0]    $.vipValue[{{tracking_object_index}}].name
    ...
    Should Be Equal Value Json Yaml UX1    ${ipv4_vrrp_track_objects}[0]    $.vipValue[{{tracking_object_index}}].track-action
    ...
    Should Be Equal Value Json Yaml UX1    ${ipv4_vrrp_track_objects}[0]    $.vipValue[{{tracking_object_index}}].decrement
...
{% endfor %}
    ...
    ${ipv6_nat_presence_nat64}=   Get Value From Json   ${ft.json()}    $..nat64..vipValue
    ${ipv6_nat_presence_nat66}=   Get Value From Json   ${ft.json()}    $..nat66
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $.ipv6-vrrp.vipValue[{{ loop.index0 }}].ipv6..["ipv6-link-local"]
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $.ipv6-vrrp.vipValue[{{ loop.index0 }}].ipv6..["prefix"]
    ...
    ${gre_encap}=    Get Value From Json    ${ft.json()}    $.tunnel-interface.encapsulation.vipValue[?(@.encap.vipValue == "gre")].encap.vipValue
    IF    ${gre_encap} != []
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $.tunnel-interface.encapsulation.vipValue[?(@.encap.vipValue == "gre")].preference
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $.tunnel-interface.encapsulation.vipValue[?(@.encap.vipValue == "gre")].weight
    ...
    ${ipsec_encap}=    Get Value From Json    ${ft.json()}    $.tunnel-interface.encapsulation.vipValue[?(@.encap.vipValue == "ipsec")].encap.vipValue
    IF    ${ipsec_encap} != []
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $.tunnel-interface.encapsulation.vipValue[?(@.encap.vipValue == "ipsec")].preference
    ...
    Should Be Equal Value Json Yaml UX1    ${ft.json()}    $.tunnel-interface.encapsulation.vipValue[?(@.encap.vipValue == "ipsec")].weight
